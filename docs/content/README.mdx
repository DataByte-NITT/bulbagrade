...
The [configuration file](https://github.com/scienstien/templaterepo/blob/main/docs/docusaurus.config.js)
...
file](https://github.com/scienstien/templaterepo/blob/main/docs/cspell.json).
...
using the [Test Docs](https://github.com/scienstien/templaterepo/blob/main/.github/workflows/test-docs.yml)
GitHub Action.
...
the [Release docs](https://github.com/scienstien/templaterepo/blob/main/.github/workflows/release-docs.yml)
GitHub Action.
...
This template ships an [`AsciinemaPlayer`](https://github.com/scienstien/templaterepo/blob/main/docs/src/components/AsciinemaPlayer/AsciinemaPlayer.js)
